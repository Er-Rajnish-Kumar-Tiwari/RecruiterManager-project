...
import { Search, Filter, Users, Calendar, CheckCircle, XCircle, Clock } from 'lucide-react';
            ...
            <div key={groupName} className="mb-6 last:mb-0">
              {groupBy !== 'none' && (
                <div className="bg-gray-100 px-4 py-2 border-b">
                  <h3 className="font-semibold text-gray-800">{groupName} ({groupOffers.length})</h3>
                </div>
              )}
                ...
                <table className="w-full">
                  <thead className="bg-gray-50">
                    <tr>
                      ...
                      <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Offer Date</th>
                      ...
                      <th className="px-2 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">0-10d</th>
                      <th className="px-2 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">20-30d</th>
                      <th className="px-2 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">30-40d</th>
                      <th className="px-2 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">40-50d</th>
                      <th className="px-2 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">50-60d</th>
                      <th className="px-2 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">60-70d</th>
                    </tr>
                  </thead>
                    ...
                    {groupOffers.map((offer) => (
                      <tr key={offer.id} className="hover:bg-gray-50">
                        <td className="px-4 py-4 whitespace-nowrap">
                          <div className="text-sm font-medium text-gray-900">{offer.positionName}</div>
                        </td>
                        <td className="px-4 py-4 whitespace-nowrap">
                          <div className="text-sm text-gray-900">{offer.candidateName}</div>
                        </td>
                        <td className="px-4 py-4 whitespace-nowrap">
                        ...
                        <td className="px-2 py-4 text-center">
                          {renderUpdateSelect(offer, 'update0to10', '0-10')}
                        </td>
                        <td className="px-2 py-4 text-center">
                          {renderUpdateSelect(offer, 'update20to30', '20-30')}
                        </td>
                        <td className="px-2 py-4 text-center">
                          {renderUpdateSelect(offer, 'update30to40', '30-40')}
                        </td>
                        <td className="px-2 py-4 text-center">
                          {renderUpdateSelect(offer, 'update40to50', '40-50')}
                        </td>
                        <td className="px-2 py-4 text-center">
                          {renderUpdateSelect(offer, 'update50to60', '50-60')}
                        </td>
                        <td className="px-2 py-4 text-center">
                          {renderUpdateSelect(offer, 'update60to70', '60-70')}
                        </td>
                      </tr>
                    ))}
                  </tbody>
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div className="bg-white rounded-lg shadow-sm p-4">
            ...
            <div className="text-2xl font-bold text-yellow-600">
              {filteredOffers.filter(o => o.status === 'Pending').length}
            </div>
          </div>
          <div className="bg-white rounded-lg shadow-sm p-4">
