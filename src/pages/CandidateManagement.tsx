...
import { Search, Plus, Edit, Filter, X, User, Mail, Phone, Building, MapPin, Clock, DollarSign, ArrowLeft, ExternalLink, FileText, Trash2, Upload } from 'lucide-react';
...
const CandidateManagement = () => {
  ...
  useEffect(() => {
    let filtered = candidates.filter(candidate => {
      ...
      const passesFilters = (
        ...
        (filters.organization === '' || candidate?.currentOrganization.toLowerCase().includes(filters.organization.toLowerCase())) &&
        (filters.designation === '' || candidate?.currentDesignation.toLowerCase().includes(filters.designation.toLowerCase()))
      );
      ...
      const passesSearch = searchQuery === '' || 
        ...
        candidate?.currentDesignation.toLowerCase().includes(searchQuery.toLowerCase()) ||
        candidate?.currentOrganization.toLowerCase().includes(searchQuery.toLowerCase()) ||
  ...
  const handleAddDocument = () => {
    ...
    setCandidates(prev => prev.map(candidate => 
      candidate?.id === currentCandidateId 
        ? { ...candidate, documents: [...(candidate?.documents || []), newDocument] }
        : candidate
    ));
  ...
  const handleDeleteDocument = (candidateId, documentId) => {
    setCandidates(prev => prev.map(candidate => 
      candidate?.id === candidateId 
        ? { ...candidate, documents: candidate?.documents.filter(doc => doc.id !== documentId) }
        : candidate
    ));
  ...
  const handleSearchCandidate = () => {
    ...
    const existingCandidate = candidates.find(c => c.email.toLowerCase() === searchEmail.toLowerCase());
    setSearchResult({
      email: searchEmail,
    ...
    if (editingCandidate) {
      setCandidates(prev => prev.map(c => 
        c.id === editingCandidate?.id 
          ? { ...formData, id: editingCandidate?.id, currentCTC: parseInt(formData.currentCTC), expectedCTC: parseInt(formData.expectedCTC), noticePeriod: parseInt(formData.noticePeriod) }
          : c
      ));
    } else {
      const newCandidate = {
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200">
            ...
            <div className="border-b border-gray-200 p-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">{selectedCandidate?.currentDesignation} at {selectedCandidate?.currentOrganization}</p>
                </div>
            ...
            <div className="p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        {isEditingDetails ? (
                          ...
                          <div className="text-gray-900">{selectedCandidate?.email}</div>
                        )}
                      </div>
                    </div>
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        {isEditingDetails ? (
                          ...
                          <div className="text-gray-900">{selectedCandidate?.phone}</div>
                        )}
                      </div>
                    </div>
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        {isEditingDetails ? (
                          ...
                          <div className="text-gray-900">{selectedCandidate?.city}</div>
                        )}
                      </div>
                    </div>
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        {isEditingDetails ? (
                          <input
                            ...
                            onChange={(e) => setEditFormData(prev => ({ ...prev, resumeLink: e.target.value }))}
                            className="w-full text-gray-900 border border-gray-300 rounded px-2 py-1 focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                          />
                        ) : (
                          <div>
                      ...
                      <div className="flex-1">
                        ...
                        {isEditingDetails ? (
                          <input
                            ...
                            onChange={(e) => setEditFormData(prev => ({ ...prev, currentOrganization: e.target.value }))}
                            className="w-full text-gray-900 border border-gray-300 rounded px-2 py-1 focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                          />
                        ) : (
                          <div className="text-gray-900">{selectedCandidate?.currentOrganization}</div>
                        )}
                      </div>
                    </div>
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        {isEditingDetails ? (
                          <input
                            ...
                            onChange={(e) => setEditFormData(prev => ({ ...prev, currentDesignation: e.target.value }))}
                            className="w-full text-gray-900 border border-gray-300 rounded px-2 py-1 focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                          />
                        ) : (
                          <div className="text-gray-900">{selectedCandidate?.currentDesignation}</div>
                        )}
                      </div>
                    </div>
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        {isEditingDetails ? (
                          <input
                            ...
                            onChange={(e) => setEditFormData(prev => ({ ...prev, currentCTC: e.target.value }))}
                            className="w-full text-gray-900 border border-gray-300 rounded px-2 py-1 focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                          />
                        ) : (
                          <div className="text-gray-900 font-semibold">{formatCurrency(selectedCandidate?.currentCTC)}</div>
                        )}
                      </div>
                    </div>
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        {isEditingDetails ? (
                          <input
                            ...
                            onChange={(e) => setEditFormData(prev => ({ ...prev, expectedCTC: e.target.value }))}
                            className="w-full text-gray-900 border border-gray-300 rounded px-2 py-1 focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                          />
                        ) : (
                          <div className="text-gray-900 font-semibold">{formatCurrency(selectedCandidate?.expectedCTC)}</div>
                        )}
                      </div>
                    </div>
                    <div className="flex items-center gap-3">
                        ...
                        {isEditingDetails ? (
                          <div className="flex items-center gap-2">
                            <input
                              ...
                              onChange={(e) => setEditFormData(prev => ({ ...prev, noticePeriod: e.target.value }))}
                          ...
                          <div className="text-gray-900">{selectedCandidate?.noticePeriod} days</div>
                        )}
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      {isEditingDetails ? (
                        ...
                        <div className="text-gray-900">{selectedCandidate?.education}</div>
                      )}
                    </div>
                    <div>
                      ...
                      {isEditingDetails ? (
                        ...
                        <div className="text-gray-900">{selectedCandidate?.gender}</div>
                      )}
                    </div>
                    <div>
                      <span className="text-sm text-gray-500">Engagement Type</span>
                      {isEditingDetails ? (
                        <select
                          value={editFormData?.engagementType || ''}
                          onChange={(e) => setEditFormData(prev => ({ ...prev, engagementType: e.target.value }))}
                          className="w-full text-gray-900 border border-gray-300 rounded px-2 py-1 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 mt-1"
                        >
                        ...
                        <div className="text-gray-900">{selectedCandidate?.engagementType}</div>
                      )}
                    </div>
                    <div>
                      ...
                      {isEditingDetails ? (
                        <label className="flex items-center gap-2 mt-1">
                          <input
                            ...
                            onChange={(e) => setEditFormData(prev => ({ ...prev, openToRelocation: e.target.checked }))}
                            className="rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                          />
                          <span className="text-gray-900">Yes, open to relocation</span>
                        </label>
                      ) : (
                        <div className="text-gray-900">{selectedCandidate?.openToRelocation ? 'Yes' : 'No'}</div>
                      )}
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      <div className="text-gray-900">{selectedCandidate?.recruiter}</div>
                    </div>
                    <div>
                      <span className="text-sm text-gray-500">Special Comments</span>
                      {isEditingDetails ? (
                        <textarea
                          value={editFormData?.specialComments || ''}
                          onChange={(e) => setEditFormData(prev => ({ ...prev, specialComments: e.target.value }))}
                          rows={3}
                          className="w-full text-gray-900 border border-gray-300 rounded px-2 py-1 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 mt-1"
                        />
                      ) : (
                        selectedCandidate?.specialComments ? (
                          <div className="text-gray-900 bg-gray-50 p-3 rounded-lg mt-1">{selectedCandidate?.specialComments}</div>
                        ) : (
                          <div className="text-gray-500 italic mt-1">No comments</div>
                        )
                      )}
                    </div>
                  </div>
                            ...
                            <div className="flex items-center gap-3">
                              ...
                              <div>
                                ...
                                <div className="text-sm text-gray-500">
                                  {document.type} • Uploaded on {new Date(document.uploadDate).toLocaleDateString('en-IN')}
                                </div>
                              </div>
                            </div>
                            <button
                              onClick={() => handleDeleteDocument(selectedCandidate?.id, document.id)}
                ...
                {/* Position History */}
                <div className="md:col-span-2">
                  <h3 className="text-lg font-semibold text-gray-900 mb-4">Candidate Position History</h3>
                  {selectedCandidate?.positionHistory && selectedCandidate?.positionHistory.length > 0 ? (
                    <div className="space-y-3">
                        ...
                        <div key={position.id} className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                              ...
                              <div className="text-gray-900 font-medium">{position.positionName}</div>
                            </div>
                            <div>
                              <div className="text-sm text-gray-500">Client Name</div>
                              <div className="text-gray-900">{position.clientName}</div>
                            </div>
                            <div>
                              <div className="text-sm text-gray-500">Current Stage</div>
                              <div className="text-gray-900">{position.currentStage}</div>
                            </div>
                            <div>
                              <div className="text-sm text-gray-500">Recruiter</div>
                              <div className="text-gray-900">{position.recruiter}</div>
                            </div>
                            <div className="md:col-span-2">
                              <div className="text-sm text-gray-500">Last Modified</div>
                              <div className="text-gray-900">
                                {new Date(position.lastModified).toLocaleString('en-IN', {
                                  year: 'numeric',
                                  month: 'short',
                                  day: 'numeric',
                                  hour: '2-digit',
              ...
              <div className="mb-4">
                ...
                {searchQuery && (
                  <div className="mt-2 text-sm text-gray-600">
                    Showing {filteredCandidates.length} candidate{filteredCandidates.length !== 1 ? 's' : ''} matching "{searchQuery}"
                  </div>
                )}
              </div>
              ...
              {showFilters && (
                <div className="bg-gray-50 p-4 rounded-lg border border-gray-200 mb-4">
                  <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4">
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-1">Min CTC (₹)</label>
                      <input
                        type="number"
                        placeholder="Min CTC"
                    ...
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-1">Max CTC (₹)</label>
                      <input
                        type="number"
                        placeholder="Max CTC"
                  ...
                  {filteredCandidates.map((candidate) => (
                    ...
                    >
                      ...
                      <td 
                        ...
                        onClick={() => setSelectedCandidate(candidate)}
                      >
                        <div className="text-sm font-medium text-gray-900">{candidate?.currentDesignation}</div>
                        <div className="text-sm text-gray-500">{candidate?.currentOrganization}</div>
                      </td>
                      <td 
                        className="px-6 py-4 whitespace-nowrap cursor-pointer"
                        onClick={() => setSelectedCandidate(candidate)}
                      >
                        <div className="text-sm font-medium text-gray-900">{formatCurrency(candidate?.currentCTC)}</div>
                        <div className="text-sm text-gray-500">Expected: {formatCurrency(candidate?.expectedCTC)}</div>
                      </td>
                      <td 
                        className="px-6 py-4 whitespace-nowrap cursor-pointer"
                        onClick={() => setSelectedCandidate(candidate)}
                      ...
                      <td 
                        ...
                        onClick={() => setSelectedCandidate(candidate)}
                      >
                        <div className="text-sm text-gray-900">{candidate?.noticePeriod} days</div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex items-center gap-2">
                          <div 
                            ...
                            onClick={() => setSelectedCandidate(candidate)}
                          >
                            {candidate?.documents?.length || 0} document{(candidate?.documents?.length || 0) !== 1 ? 's' : ''}
                          </div>
                          <button
                            onClick={(e) => {
                              e.stopPropagation();
                        ...
                        {candidate?.documents && candidate?.documents.length > 0 && (
                          <div className="mt-1">
                            {candidate?.documents.slice(0, 2).map((doc, index) => (
            ...
            <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
              ...
              {!editingCandidate && (
                <div className="p-6 border-b border-gray-200 bg-gray-50">
                  <h3 className="text-lg font-medium text-gray-900 mb-4">Search for Existing Candidate</h3>
                  <div className="space-y-3">
                    <div className="flex gap-3">
                      <div className="flex-1">
                        <input
                    ...
                    {searchResult && (
                      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                        {searchResult.exists ? (
                          <div className="flex items-center justify-between">
                            <div>
                              <p className="text-blue-800 font-medium">Candidate found: {searchResult.candidate?.name}</p>
                              <p className="text-blue-600 text-sm">{searchResult.email}</p>
                            </div>
                            <button
                          ...
                          <div className="flex items-center justify-between">
                            <div>
                              <p className="text-blue-800 font-medium">No candidate found with this email</p>
                              <p className="text-blue-600 text-sm">{searchResult.email}</p>
                            </div>
                            <button
                  ...
                  <div className="md:col-span-2">
                    <label className="flex items-center gap-2">
                      <input
                        ...
                        onChange={(e) => setFormData(prev => ({ ...prev, openToRelocation: e.target.checked }))}
                        className="rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                      />
                      <span className="text-sm font-medium text-gray-700">Open to Relocation</span>
                    </label>
                  </div>
                </div>
